...
import 'package:tm_aaaa/dialog/revoke/revoke_controller.dart';
...
class RevokeDialog extends TmRootDialog<RevokeController>{
  Function() dismiss;
  RevokeDialog({required this.dismiss});

  @override
  RevokeController initTmController() => RevokeController();
  ...
  _contentWidget()=>SizedBox(
    ...
    child: Stack(
      ...
      children: [
        tmImage(imageName: "revoke_bg",width: double.infinity,height: double.infinity),
        Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            ...
            Container(
              ...
              child: tmText(data: "Undo the most recent card,put it in its original place", fontSize: 14.sp, colorStr: "#000000",textAlign: TextAlign.center),
            ),
            SizedBox(height: 20.h,),
            WatchVideoBtnView(
              onTap: (){
