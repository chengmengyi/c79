...
import 'package:tm_aaaa/dialog/reset/reset_controller.dart';
...
class ResetDialog extends TmRootDialog<ResetController>{
  Function() dismiss;
  ResetDialog({required this.dismiss});

  @override
  ResetController initTmController() => ResetController();
  ...
  _contentWidget()=>SizedBox(
    ...
    child: Stack(
      ...
      children: [
        tmImage(imageName: "reset_bg",width: double.infinity,height: double.infinity),
        Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            ...
            Stack(
              ...
              children: [
                tmImage(imageName: "icon_reset",width: 84.w,height: 84.h),
                Container(
                  width: 24.w,
                  height: 24.w,
                  alignment: Alignment.center,
            ...
            Container(
              ...
              child: tmText(data: "Randomly shuffle unused cards", fontSize: 14.sp, colorStr: "#000000",textAlign: TextAlign.center),
            ),
            SizedBox(height: 20.h,),
            WatchVideoBtnView(
              onTap: (){
